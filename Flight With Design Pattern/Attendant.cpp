...
// Constructor
Attendant::Attendant(const int employeeID, const string name, const int firstAidKnowledge, const Luggage* luggage) noexcept(false) : Crew(employeeID, name), Human(name)
{
